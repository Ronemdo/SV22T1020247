...
public static class PartnerDataService
{
    ...
    private static readonly CategoryRepository categoryDB;
    ...
    /// <summary>
    /// Lấy toàn bộ danh sách loại hàng (không phân trang, dùng cho dropdown)
    /// </summary>
    public static async Task<List<Category>> ListCategoriesAsync()
    {
        return await categoryDB.ListAsync();
    }
